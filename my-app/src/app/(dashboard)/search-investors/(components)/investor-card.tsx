        ...
        <div className="flex items-start justify-between">
          <div className="flex items-start space-x-4 flex-1">
            ...
            <div className="flex-1 min-w-0 pr-5">
              <h3 className="font-semibold text-md text-gray-900 leading-tight mb-1">{displayName(investor)}</h3>
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${!isBioExpanded ? "h-16" : "h-auto"}`}
              >
                  ...
                  {investor.bio && investor.bio.length > 100 && (
                    <>
                      ...
                      <button
                        ...
                        className="ml-1 text-xs text-blue-600 hover:text-blue-800 font-medium transition-colors inline"
                      >
